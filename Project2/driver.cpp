...
int main()
{
	...
	std::uniform_int_distribution<int> indexX = std::uniform_int_distribution<int>(20, 280);
	std::uniform_int_distribution<int> indexY = std::uniform_int_distribution<int>(20, 90);
